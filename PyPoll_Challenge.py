    ...
    for row in reader:
        ...
        if county_name not in counties_options:
           ...
           # 4c: Begin tracking the county's vote count.
            county_voters[county_name] = 0

        # 5: Add a vote to that county's vote count.
        county_voters[county_name] += 1
...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_voters:
     # 6b: Retrieve the county vote count.
        votes_county = county_voters[county_name]
     # 6c: Calculate the percent of total votes for the county.
        ...
        county_results=(f"{county_name}: {county_vote_percentage:.2f}%({votes_county:,})\n")
    ...
    # 8: Save the county with the largest turnout to a text file.
        if (votes_county > largest_turnout):
            largest_turnout = votes_county
